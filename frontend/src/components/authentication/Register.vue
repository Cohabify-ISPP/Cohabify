      ...
      <form class="row justify-content-center" @submit.prevent="onSubmit">
        <div class="col-md-6" style="padding-inline: 20px;">
          ...
          <div class="form-group" style="padding: 20px;">
            ...
            <input type="tel" required pattern="[0-9]{9}" class="form-control" id="phone" v-model="phone"
        ...
        <div class="col-md-6" style="padding-inline: 20px;">
          <div class="form-group" style="padding: 20px;">
            ...
            <input type="text" required class="form-control" id="username" v-model="username"
              placeholder="Nombre de usuario">
          </div>
          <div class="form-group" style="padding: 20px;">
            <label for="formFile" class="form-label text-white fw-bold">Imagen de perfil</label>
            <input class="form-control" type="file" required accept="image/*" @change="onFileChanged($event)"
              id="formFile">
          </div>
          <div class="form-group" style="padding: 20px;">
    ...
    const onSubmit = () => {
      ...
      if (!passwordError.value) {
        const data = {
          ...
          isPasswordSafe: isPasswordSafe.value,
