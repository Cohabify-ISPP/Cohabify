              ...
              <div class="row mt-5">
                  ...
                  <div class="col">
                      ...
                      <select id="tags" name="tags" v-model="tags" class="form-select" size="3" multiple aria-label="Size 3 select example" required>
                        <option value="TAG_UNO">Uno</option>
                        <option value="TAG_DOS">Dos</option>
                        <option value="TAG_TRES">Tres</option>
                      </select>
                  </div>
              </div>
              <div class="row mt-5">
                  <div class="d-flex justify-content-between">
                      ...
                      <div style="padding-right: 10%;">
                          ...
                          <input type="number" class="form-control text-center" id="tenants" v-model="tenants" required>
                      </div>
                      <div>
